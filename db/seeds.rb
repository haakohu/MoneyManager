...
income = MasterCategory.create(name: 'Income')
...
Category.create(name: 'Other',master_category: income)
Category.create(name: 'Child support',master_category: income)
Category.create(name: 'Investments',master_category: income)
Category.create(name: 'Rental',master_category: income)
Category.create(name: 'Salary & Wages',master_category: income)
Category.create(name: 'Loan',master_category: income)
Category.create(name: 'Social Security',master_category: income)
