...
ActiveRecord::Schema.define(version: 20160320193652) do
  ...
  add_index "categories", ["master_category_id"], name: "index_categories_on_master_category_id"
  ...
  add_index "outcomes", ["account_id"], name: "index_outcomes_on_account_id"
  add_index "outcomes", ["category_id"], name: "index_outcomes_on_category_id"
